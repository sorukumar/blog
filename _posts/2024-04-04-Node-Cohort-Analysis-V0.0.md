...
**Methodology:** 
	 ...
	 - New and resurrected nodes for a month are nodes we are seeing for the first time in the observation window, for our case it is from October-23  to April-24 . For December cohort,  the # of new and resurrected nodes are nodes that we say first time in December in our observation window. this number is nodes that we didnt see in october and november, and we saw it first time in December. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU0MTM1ODQzMSwzODQ3NDk3NzRdfQ==
-->