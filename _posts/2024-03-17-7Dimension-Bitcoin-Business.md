...
![Seven Dimension to understand Bitcoin Businessess]({{ 'assets/Bitcoin-Business-7-dimension.png' | relative_url }})
 ...
 5. **Existing use case or Novel use case:** For companies, that are building for the transactional use case of bitcoin, novel use-case would be where a digital money has inherent advantage - AI agent payment, remittance, Micropayments. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTM0MDI2OTIsMTAzMTcxOTE4NSwxMDIxMz
U1MjczXX0=
-->